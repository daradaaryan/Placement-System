...
--     Company_Website VARCHAR(260) NOT NULL,
...
--     CONSTRAINT chk_organization_type CHECK (Organization_Type IN ('Public', 'Private', 'Non-Profit'))
-- );
...
-- ADD POC_Email VARCHAR(255) NOT NULL;
...
CREATE TABLE Placement (
    ...
    Placement_Method VARCHAR(100) NOT NULL,
...
CREATE TABLE Academic_Info (
	Academic_Info_ID INT PRIMARY KEY,
	Transcript_File VARCHAR(255) NOT NULL,
	CPI DECIMAL(3, 2) NOT NULL,
	SSAC_or_Not VARCHAR(100) NOT NULL
);
